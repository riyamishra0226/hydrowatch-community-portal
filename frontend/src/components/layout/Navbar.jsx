  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        <Link to="/" className="flex items-center gap-2" aria-label="HydroWatch Home">
          <FaTint className="text-3xl text-sky-500" />
          <h1 className="text-2xl font-bold text-slate-800">HydroWatch</h1>
        </Link>
        ...
        <div className="flex items-center gap-4">
          <Link to="/login" className="text-slate-700 hover:text-sky-500 transition">Login</Link>
          <Link to="/register" className="bg-sky-500 text-white px-5 py-2 rounded-lg hover:bg-sky-600 transition">Register</Link>
        </div>
      </div>
    </nav>
  );
